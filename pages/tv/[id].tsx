                ...
                <div className={styles.movieSearchBody}>
                    ...
                    <div className={styles.movieInfo}>
                        <div className={styles.movieImage}>
                            {TVInfo && <Image src={`https://image.tmdb.org/t/p/w342${TVInfo.poster_path}`} width={342} height={513}/>}
                        </div>
                            ...
                            <div className={styles.streamingPlatforms}>
                                ...
                                <div className={styles.streamingPlatformsList}>
                                    ...
                                    :
                                        ...
                                        : 
                                            Object.keys(countriesList).length > 0 ? <ErrorNotAvailableInCountry mediaType="tv" /> : <ErrorNotAvailable mediaType="tv" />
                                        )
                                    }
                                </div>
                            </div>
